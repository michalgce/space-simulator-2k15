...
public class AsteroidsDiskOverPlanet : MonoBehaviour
{
	private float maxDistance = 100;
	public float promienWewnetrzny = 50;
	public float promienZewnetrzny = 55;
	public int ilosc = 10;
	public float szybkosc = 1; 
	...
	void Start ()
	{
		...
		disk = gameObject.AddComponent<DiskProperties> ();
		disk.srodek = transform.position;
		disk.promienWewnetrzny = promienWewnetrzny;
		disk.promienZewnetrzny = promienZewnetrzny;
		disk.ilosc = ilosc;
		disk.szybkosc = szybkosc;
		GenerujDysk (disk);
